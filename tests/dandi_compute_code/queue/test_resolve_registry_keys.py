...
def test_resolve_params_key_to_id_aind_ephys_default() -> None:
    ...
    result = QueueState.resolve_params_key_to_id(pipeline="aind+ephys", params_key="default")
...
def test_resolve_params_key_to_id_lfp_default() -> None:
    ...
    result = QueueState.resolve_params_key_to_id(pipeline="lfp", params_key="default")
    expected = _registry_id(
...
def test_resolve_params_key_to_id_unknown_pipeline_returns_key() -> None:
    ...
    result = QueueState.resolve_params_key_to_id(pipeline="unknown-pipeline", params_key="default")
...
def test_resolve_params_key_to_id_already_hash_passthrough() -> None:
    ...
    result = QueueState.resolve_params_key_to_id(pipeline="aind+ephys", params_key="98fd947")
...
def test_resolve_config_key_to_id_aind_ephys_default() -> None:
    ...
    result = QueueState.resolve_config_key_to_id(pipeline="aind+ephys", config_key="default")
    expected = _registry_id(
...
def test_resolve_config_key_to_id_lfp_has_no_config() -> None:
    ...
    result = QueueState.resolve_config_key_to_id(pipeline="lfp", config_key="default")
...
def test_resolve_config_key_to_id_unknown_pipeline_returns_key() -> None:
    ...
    result = QueueState.resolve_config_key_to_id(pipeline="unknown-pipeline", config_key="default")
